/* eslint-env node, es6 */
/* global Promise */
/* eslint-disable object-curly-spacing, indent, space-before-function-paren, quotes, key-spacing, one-var, no-multi-spaces, max-nested-callbacks, quote-props, strict */
...
options.styleGuide = {
  ...
  css: [
    ...
    path.relative(
      ...
      options.theme.css + "layouts.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "chroma-kss-styles.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "kss-only.css"
    ),
    path.relative(options.rootPath.styleGuide, options.theme.css + "box.css"),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "clearfix.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
    ...
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "footer.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "header.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "hidden.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "highlight-mark.css"
    ),
    path.relative(options.rootPath.styleGuide, options.theme.css + "icons.css"),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "inline-links.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "inline-sibling.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "messages.css"
    ),
    path.relative(options.rootPath.styleGuide, options.theme.css + "modal.css"),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "print-none.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "responsive-video.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "visually-hidden.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "watermark.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "wireframe.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "autocomplete.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "collapsible-fieldset.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "form-item.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "form-table.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "progress-bar.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "progress-throbber.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "resizable-textarea.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "table-drag.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "breadcrumb.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "megamenu.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "more-link.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "nav-menu.css"
    ),
    path.relative(
      options.rootPath.styleGuide,
    ...
    path.relative(
      options.rootPath.styleGuide,
      options.theme.css + "skip-link.css"
    ),
...
// Build everything.
// #################
// gulp.task("build", gulp.series(gulp.parallel("styles:production", "styleguide", "lint")));
...
gulp.task("lint:sass", function() {
  return gulp
    .src(options.theme.components + "**/*.scss")
    .pipe($.sassLint())
...
// ######################
// gulp.task("clean", gulp.series(gulp.parallel("clean:css", "clean:styleguide")));
...
// Build style guide.
// ##################
// gulp.task("styleguide", gulp.series(gulp.parallel("clean:styleguide", "styleguide:kss-example-chroma"), function() {
//   return kss(options.styleGuide);
// }));

gulp.task("styleguide:kss-example-chroma", function() {
  return gulp
    .src(options.theme.components + "style-guide/kss-example-chroma.scss")
    .pipe(sass(options.sass).on("error", sass.logError))
    .pipe($.replace(/(\/\*|\*\/)\n/g, ""))
...
gulp.task(
  "styleguide:debug",
  gulp.series(
    gulp.parallel("clean:styleguide", "styleguide:kss-example-chroma"),
    function() {
...
// ##############################
// gulp.task("watch", gulp.series(gulp.parallel("browser-sync", "watch:lint-and-styleguide", "watch:js", "drush:cr")));

// // for running styleguide outside of drupal
// gulp.task("watch-styleguide", gulp.series(gulp.parallel("browser-sync", "watch:lint-and-styleguide", "watch:js")));
...
gulp.task(
  "watch:css",
  gulp.series(gulp.parallel("clean:css", "styles"), function() {
    return gulp.watch(
      options.theme.components + "**/*.scss",
      gulp.series("styles")
    );
...
gulp.task(
  "browser-sync",
  gulp.series("watch:css", function() {
...
gulp.task(
  "watch:lint-and-styleguide",
  gulp.series(gulp.parallel("styleguide", "lint:sass"), function() {
    return gulp.watch(
      [
        options.theme.components + "**/*.scss",
        options.theme.components + "**/*.twig"
      ],
      gulp.series("styleguide", "lint:sass")
    );
  })
);
...
gulp.task(
  "watch:js",
  gulp.series("lint:js", function() {
    return gulp.watch(options.eslint.files, gulp.series("lint:js"));
  })
);
...
gulp.task(
  "watch",
  gulp.series(
    gulp.parallel("browser-sync", "watch:lint-and-styleguide", "watch:js")
  )
);
...
gulp.task("build", gulp.series(gulp.parallel("styles", "styleguide", "lint")));
