...
class ProviderUrlParseTest extends UnitTestCase {
  ...
  public function urlsWithExpectedIds() {
    return [
      ...
      'YouTube: With Language Preference' => [
        'Drupal\video_embed_field\Plugin\video_embed_field\Provider\YouTube',
        'https://youtube.com/watch?v=fdbFVWupSsw&hl=fr-ca',
        'fdbFVWupSsw',
      ],
      ...
      'YouTube: Added Query String in first position' => [
        'Drupal\video_embed_field\Plugin\video_embed_field\Provider\YouTube',
        'https://youtube.com/watch?feature=player_detailpage&v=fdbFVWupSsw',
        'fdbFVWupSsw',
      ],
  ...
  public function languageParseTestCases() {
    return [
      'Simple Preference' => [
        'https://youtube.com/watch?v=fdbFVWupSsw&hl=fr',
        'fr',
      ],
      ...
      'Invalid Language' => [
        'https://youtube.com/watch?v=fdbFVWupSsw&hl=<test>',
        FALSE,
      ],
      'Multiple Parameters' => [
        'https://youtube.com/watch?v=fdbFVWupSsw&hl=au&anotherparam=1',
        'au',
      ],
    ];
  }
